...
<body>
	...
	<header>
		<a href="index.jsp"><img
			...
			alt="logo" class="logo" /></a> <input type="checkbox" id="check" />
		<label for="check" class="icons"> <i class="bx bx-menu"
		...
		<nav class="navbar">
			...
			<a href="cesta.jsp" class="nav-item">Cesta><!-- <span id="total"> 0</span>  -->
				...
				<div class="product-details  mr-2">
					...
					<div
						...
						<div class="d-flex flex-row">
							<img class="rounded img-fluid"
								...
								width="40">
							<div class="ml-2">
								<span class="font-weight-bold d-block"><b>FashionFusionHQ</b></span><span
									class="spec">Pack Basico</span>
							</div>
						</div>
						<div class="d-flex flex-row align-items-center">
							<span class="d-block ml-5 font-weight-bold"><button
									class="botonAniadirCesta" id="btnAdd89">+</button>89€
								<button class="botonRestarCesta" id="btnSubtract89">-</button></span><i
					...
					<div
						...
						<div class="d-flex flex-row">
							...
							<div class="ml-2">
								<span class="font-weight-bold d-block"><b>MindfulMeditator</b></span><span
									class="spec">Pack Basico</span>
							</div>
						</div>
						<div class="d-flex flex-row align-items-center">
							<span class="d-block ml-5 font-weight-bold"><button
									class="botonAniadirCesta" id="btnAdd120">+</button>120€
								<button class="botonRestarCesta" id="btnSubtract120">-</button></span><i
								class="fa fa-trash-o ml-3 text-black-50"></i>
						</div>
					</div>
					<div
						...
						<div class="d-flex flex-row">
							<img class="rounded img-fluid"
								...
								width="40">
							<div class="ml-2">
								<span class="font-weight-bold d-block"><b>CulinaryCraftsmen</b></span><span
									class="spec">Pack premium</span>
							</div>
						</div>
						<div class="d-flex flex-row align-items-center">
							<span class="d-block ml-5 font-weight-bold">
							<button class="botonAniadirCesta" id="btnAdd88">+</button>88€
								<button class="botonRestarCesta" id="btnSubtract88">-</button></span><i
								class="fa fa-trash-o ml-3 text-black-50"></i>
						</div>
					</div>
					<div
						...
						<div class="d-flex flex-row">
							...
							<div class="ml-2">
								<span class="font-weight-bold d-block"><b>ArtisanCrafters</b></span><span
									class="spec">Pack Basico</span>
							</div>
						</div>
						<div class="d-flex flex-row align-items-center">
							</span><span class="d-block ml-5 font-weight-bold"><button
									class="botonAniadirCesta" id="btnAdd75">+</button>75€
								<button class="botonRestarCesta" id="btnSubtract75">-</button></span><i
								class="fa fa-trash-o ml-3 text-black-50"></i>
						</div>
					</div>
